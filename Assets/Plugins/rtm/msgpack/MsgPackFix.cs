...
namespace GameDevWare.Serialization {
    ...
    public static class MsgPackFix {
        public static string[] DefaultDateTimeFormats {
            get {
                return Json.DefaultDateTimeFormats;
            }
            set {
                Json.DefaultDateTimeFormats = value;
            }
        }
        public static IFormatProvider DefaultFormat {
            get {
                return Json.DefaultFormat;
            }
            set {
                Json.DefaultFormat = value;
            }
        }
        public static Encoding DefaultEncoding {
            get {
                return Json.DefaultEncoding;
            }
            set {
                Json.DefaultEncoding = value;
            }
        }
        public static List<TypeSerializer> DefaultSerializers {
            get {
                return Json.DefaultSerializers;
            }
        }
        public static MessagePackExtensionTypeHandler ExtensionTypeHandler {
            get;
            private set;
        }
        ...
        // fix
        public static void Serialize<T>(T objectToSerialize, Stream msgPackOutput, Encoding encoding) {
            Serialize(objectToSerialize, msgPackOutput, CreateDefaultContext(SerializationOptions.None, encoding));
        }
        ...
        public static void Serialize<T>(T objectToSerialize, Stream msgPackOutput, SerializationContext context) {
            if (msgPackOutput == null) {
                throw new ArgumentNullException("msgPackOutput");
            }
            ...
            var writer = new MsgPackFixWriter(msgPackOutput, context);
        ...
        // fix
        public static object Deserialize(Type objectType, Stream msgPackInput, Encoding encoding) {
            return Deserialize(objectType, msgPackInput, CreateDefaultContext(SerializationOptions.None, encoding));
        }
        ...
        // fix
        public static T Deserialize<T>(Stream msgPackInput, Encoding encoding) {
            return Deserialize<T>(msgPackInput, CreateDefaultContext(SerializationOptions.None, encoding));
        }
