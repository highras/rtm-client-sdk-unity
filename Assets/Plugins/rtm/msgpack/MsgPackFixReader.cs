...
namespace GameDevWare.Serialization.MessagePack {
    ...
    public class MsgPackFixReader : IJsonReader {
        ...
        internal class MsgPackValueInfo : IValueInfo {
            ...
            private readonly MsgPackFixReader reader;
            private object value;

            // fix
            // internal MsgPackValueInfo(MsgPackReader reader) {
            internal MsgPackValueInfo(MsgPackFixReader reader) {
                if (reader == null) {
            ...
            public bool AsBoolean {
                get {
                    return Convert.ToBoolean(this.Raw, this.reader.Context.Format);
                }
            }
            public byte AsByte {
                get {
                    return Convert.ToByte(this.Raw, this.reader.Context.Format);
                }
            }
            public short AsInt16 {
                get {
                    return Convert.ToInt16(this.Raw, this.reader.Context.Format);
                }
            }
            public int AsInt32 {
                get {
                    return Convert.ToInt32(this.Raw, this.reader.Context.Format);
                }
            }
            public long AsInt64 {
                get {
                    return Convert.ToInt64(this.Raw, this.reader.Context.Format);
                }
            }
            public sbyte AsSByte {
                get {
                    return Convert.ToSByte(this.Raw, this.reader.Context.Format);
                }
            }
            public ushort AsUInt16 {
                get {
                    return Convert.ToUInt16(this.Raw, this.reader.Context.Format);
                }
            }
            public uint AsUInt32 {
                get {
                    return Convert.ToUInt32(this.Raw, this.reader.Context.Format);
                }
            }
            public ulong AsUInt64 {
                get {
                    return Convert.ToUInt64(this.Raw, this.reader.Context.Format);
                }
            }
            public float AsSingle {
                get {
                    return Convert.ToSingle(this.Raw, this.reader.Context.Format);
                }
            }
            public double AsDouble {
                get {
                    return Convert.ToDouble(this.Raw, this.reader.Context.Format);
                }
            }
            public decimal AsDecimal {
                get {
                    return Convert.ToDecimal(this.Raw, this.reader.Context.Format);
                }
            }
        ...
        internal MsgPackValueInfo Value {
            get;
            private set;
        }
        ...
        public MsgPackFixReader(Stream stream, SerializationContext context, Endianness endianness = Endianness.BigEndian, byte[] buffer = null) {
            if (stream == null) {
            ...
            if (formatValue >= (byte)MsgPackType.FixArrayStart && formatValue <= (byte)MsgPackType.FixArrayEnd) {
                ...
                switch ((MsgPackType)formatValue) {
                    ...
                    case MsgPackType.Str8:
                        ...
                        var strBytes = this.ReadBytes(strBytesCount, forceNewBuffer: true);
                        ...
                        try {
                            ...
                            this.Value.SetValue(strBytes.Array, strTokenType, pos);
                        }
        ...
        private ArraySegment<byte> ReadBytes(long bytesRequired, bool forceNewBuffer = false) {
            if (bytesRequired > int.MaxValue) {
                throw new ArgumentOutOfRangeException("bytesRequired");
            }
